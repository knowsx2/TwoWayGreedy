...
def elaborate_trees(node):
    ...
    ----------
    node: node
        Root of a tree structure returned by trees()


    Returns
    -------
    nodes : node list
        list of roots of all trees elaborated
...
def filter_solutions(domains, old_solutions):
    ...
    old_solutions: list of solution that will be filtered

    Returns
    -------
    new_solutions : solution list
        list of solutions after filtered process
...
def trees(players, directions, domains, solutions, appr=1):
    ...
    solutions: solutions list
        available solution in the game
...
def all_directions_games(players, solutions):
    """
    generator of games with all possible directions
    ...
    -------
    game:
       game with same players and solutions but different directions
    """
...
def possible_queries(players, directions, domains, solutions, appr=1):
    """
    generator of possible queries that can be make in a certain point of history
    ...
    -------
    node:
       a possible node for the current history
    """
    def is_query_possible(node):
        ...
        ----------
        node: node
           a node for the current history
...
def check_if_sol_exists(list):
    ...
    ----------
    list: node list
       Must be a list of structures compute by trees()
